...
describe 'an admin visits the admin order show page' do
  it 'shows orders attributes' do
    user = User.create!(first_name: "keegan", last_name: "c", username: "oijads", address: "23 ab street", password: "oiajsiod")
    admin = User.create!(first_name: "keegan", last_name: "c", username: "admin", password: "oiajsiod", role: 1)
