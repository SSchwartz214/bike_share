...
describe Condition, type: :model do
  ...
  describe "class methods" do
    it ".highest_rides" do
      ...
      condition_3 = Condition.create!(date: Date.strptime("8/28/2013", '%m/%d/%Y'), max_temperature_f: 95, mean_temperature_f: 60, min_temperature_f: 123, mean_humidity: 3, mean_visibility_miles: 10, mean_wind_speed_mph: 27, precipitation_inches: 11)

      trip_1 = Trip.create!(duration: 100, start_date: DateTime.strptime("8/29/2013", '%m/%d/%Y'), start_station: station_1, end_date: DateTime.strptime("8/29/2013", '%m/%d/%Y'), end_station: station_1, subscription_type: "subscribed", zip_code: 12345, bike_id: 1)
