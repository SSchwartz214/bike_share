...
describe "a visitor" do
  visits "trips index" do
    it "can see all trips and attributes" do
      ...
      trip_2 = Trip.create!(duration: 198, start_date: "8/28/2013 14:19", start_station_id: 4, end_date: "8/29/2013 14:17", end_station_id: 5, subscription_type: "visitor", zip_code: 12444)
